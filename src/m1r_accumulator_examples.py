...
#        and one is WRONG.  Which is the WRONG one? The second one because it updates x by the diameter and by a
#        multiple of k when you only need one
#
#              x = starting_point.x
#              for k in range(n):
