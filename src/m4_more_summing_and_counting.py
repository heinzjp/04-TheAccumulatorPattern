...
def run_test_factorial():
    ...
    # Test 5:
    answer_from_oracle = math.factorial(87)
    answer_from_my_code = factorial(87)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 1
    answer = count_cosines_from(1, 4, .4)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 4
    answer = count_cosines_from(5, 10, -.2)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 3
    answer = count_cosines_from(9, 12, -.9)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(56, 60, .6)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 5
    answer = count_cosines_from(0, 5, -.90)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = .3892607393  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(11, 15)
